...
def weather_report.each do |"New York", "Partly Cloudy", 75|
  return "The weather in #{:city} is #{:description}. The temperature is #{:temperature_farenheit} degrees Farenheight."
end
